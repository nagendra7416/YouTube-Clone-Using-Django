"""
Django settings for reelyoutube project.
...
SECRET_KEY = 'django-insecure-he3j&%$n(^al%f_#&qjgwy(vo(qhfrxl2$e(miwgq$-wd7fed8'
...
WSGI_APPLICATION = 'reelyoutube.wsgi.application'
